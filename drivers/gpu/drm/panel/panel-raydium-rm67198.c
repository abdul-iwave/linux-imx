 ...
 *
 * Copyright (C) 2019 iWave System Technologies Pvt Ltd.
 *
 ...
 */
/* IWG37M: Workaround: Using display timing parameters from reference
 * driver 'panel-raydium-rm67191.c' for display timing issue.
 */ 
